...
return [
    ...
    */
    ...
    'copy_confirm'                            => 'Скопировать этот сайт?',
    'copy_confirm_teaser'                     => 'Скопировать этот тизер?',
    'delete_confirmation_title'               => 'Запись удалена',
    'copy_confirmation_title'                 => 'Запись скопирована',
    'delete_confirmation_message'             => 'Запись была успешно удалена',
    'copy_confirmation_message'               => 'Запись была успешно скопирована',
    'delete_confirmation_not_title'           => 'НЕ удалено',
    'copy_confirmation_not_title'             => 'НЕ скопировано',
    'delete_confirmation_not_message'         => 'Произошла ошибка. Запись не была удалена',
    'copy_confirmation_not_message'           => 'Произошла ошибка. Запись не была скопирована',
    'delete_confirmation_not_deleted_title'   => 'Не удалено',
    'copy_confirmation_not_copied_title'      => 'Не скопировано',
    'delete_confirmation_not_deleted_message' => 'Ничего не произошло. Ваша запись сохранена/',
    'copy_confirmation_not_copied_message'    => 'Копирование отменено',
